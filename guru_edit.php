...
if(isset($_POST['btnSimpan'])){
	...
	if (count($pesanError)>=1 ){
		...
		$mySql	= "UPDATE guru  SET 
						...
						no_telepon='$txtNoTelepon', pendidikan='$txtPendidikan', 
						bidang_studi='$txtBidangStudi', foto='$file_foto', status_aktif='$cmbStatus'
...
$myData = mysql_fetch_array($myQry); 
	...
	$dataStatus		= isset($_POST['cmbJabatan']) ? $_POST['cmbJabatan'] : $myData['status_aktif'];
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="post" enctype="multipart/form-data" target="_self">
  <table class="table table-dark" width="100%" border="0" cellpadding="3" cellspacing="1">
    ...
    <tr>
      ...
      <td><b>:</b></td>
      <td><input name="txtNoTelepon" type="text" value="<?php echo $dataNoTelepon; ?>" size="30" maxlength="25"></td>
    </tr>
    <tr>
