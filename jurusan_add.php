...
if(isset($_POST['btnSimpan'])){
	...
	if (count($pesanError)>=1 ){
		...
		$kodeBaru	= buatKode("jurusan", "J");
		$mySql	= "INSERT INTO jurusan (kode_jurusan, nama_jurusan, keterangan) VALUES ('$kodeBaru', '$txtJurusan', '$txtKeterangan')";
		$myQry	= mysql_query($mySql, $koneksidb) or die ("Gagal query".mysql_error());
		if($myQry){
			echo "<meta http-equiv='refresh' content='0; url=?open=Jurusan-Add'>";
		}
		exit;
	}	
} // Penutup POST
...
$dataKode		= buatKode("jurusan", "J");
$dataJurusan	= isset($_POST['txtJurusan']) ? $_POST['txtJurusan'] : '';
...
<table width="100%" cellpadding="2" cellspacing="1" class="table table-dark" style="margin-top:0px;">
	<tr>
	  <td colspan="3" bgcolor="#F5F5F5"><strong>TAMBAH DATA JURUSAN </strong></td>
	</tr>
	<tr>
